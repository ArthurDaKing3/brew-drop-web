...
const Catalog = ({categories, drinks, discounts})=>{
    ...
    async function saveChanges(item, itemType){
        ...
        // for (const inputValue of Object.values(inputValues)) {
        //     if (inputValue == null || inputValue == undefined || inputValue == "") {
        //         warning = "Favor de llenar todos los campos.";
        //         break;
        //     }
        ...
        //         if (image == "" && Object.keys(itemsToUpdate).length == 0) {
        //             warning =
        //                 "No se encontró ningun cambio a guardar, verifica los datos y vuelve a intentar.";
        //         }
    
        //         if (image != "") {
        //             // IMAGE VALIDATIONS
        //             if (image.size > 11365697) {
        //                 warning = "El tamaño de la imagen excede el límite, intenta subir otra imagen";
        //                 break;
        //             }
        ...
        //                 image.type != "image/jpeg"
        //             ) {
        //                 warning = "La extensión seleccionada no es compatible para imágenes, favor de utilizar .png .jpg o .jpeg";
        //                 break;
        //             }
        ...
        //             } catch (error) {
        //                 warning = `Ocurrió un error al subir la imagen: ${error}`;
        //                 break;
        //             }
        //         }
        //     } else if (Object.keys(itemsToUpdate).length == 0) {
        //         warning = "No se encontró ningún cambio a guardar, verifica los datos y vuelve a intentar.";
        //         break;
        //     }
        // }
